...
int InstancingCube::genSphere(int numSlices, float radius, GLfloat **vertices, GLfloat **normals,
...
int InstancingCube::genCube(float scale, GLfloat **vertices, GLfloat **normals, GLfloat **texCoords, GLuint **indices)
{
    int i;
    int numVertices = 24;
    int numIndices = 36;
...
int InstancingCube::genSquareGrid(int size, GLfloat **vertices, GLuint **indices)
{
    int i, j;
