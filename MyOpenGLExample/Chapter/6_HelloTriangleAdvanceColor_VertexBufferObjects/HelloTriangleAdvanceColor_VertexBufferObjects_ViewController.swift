//
//  HelloTriangleAdvanceColor_VertexBufferObjects_ViewController.swift
//  MyOpenGLExample
//
...
class HelloTriangleAdvanceColor_VertexBufferObjects_ViewController: GLKViewController {

    var glkView: GLKView!
    var context: EAGLContext!
    
    var engine: HelloTriangleAdvanceColor_VertexBufferObjects_EngineWrapper!
    ...
    override func viewDidLoad() {
        ...
        engine = HelloTriangleAdvanceColor_VertexBufferObjects_EngineWrapper()
