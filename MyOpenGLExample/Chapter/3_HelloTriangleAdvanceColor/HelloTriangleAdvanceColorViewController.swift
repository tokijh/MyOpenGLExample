//
//  HelloTriangleAdvanceColorViewController.swift
//  MyOpenGLExample
//
...
class HelloTriangleAdvanceColorViewController: GLKViewController {

    var glkView: GLKView!
    var context: EAGLContext!
    
    var engine: HelloTriangleAdvanceColorEngineWrapper!
    ...
    override func viewDidLoad() {
        ...
        engine = HelloTriangleAdvanceColorEngineWrapper()
