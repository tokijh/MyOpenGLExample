//
//  HelloTriangleColorViewController.swift
//  MyOpenGLExample
//
...
class HelloTriangleColorViewController: GLKViewController {

    var glkView: GLKView!
    var context: EAGLContext!
    
    var engine: HelloTriangleColorEngineWrapper!
    ...
    override func viewDidLoad() {
        ...
        engine = HelloTriangleColorEngineWrapper()
