//
//  Simple_VertexShader_ViewController.swift
//  MyOpenGLExample
//
...
class Simple_VertexShader_ViewController: GLKViewController {

    var glkView: GLKView!
    var context: EAGLContext!
    
    var engine: Simple_VertexShader_EngineWrapper!
    ...
    override func viewDidLoad() {
        ...
        engine = Simple_VertexShader_EngineWrapper()
...
extension Simple_VertexShader_ViewController: GLKViewControllerDelegate {
