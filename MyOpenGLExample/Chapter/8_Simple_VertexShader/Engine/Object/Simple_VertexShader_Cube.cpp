...
int Simple_VertexShader_Cube::genSphere(int numSlices, float radius, GLfloat **vertices, GLfloat **normals,
...
int Simple_VertexShader_Cube::genCube(float scale, GLfloat **vertices, GLfloat **normals, GLfloat **texCoords, GLuint **indices)
{
    int i;
    int numVertices = 24;
    int numIndices = 36;
...
int Simple_VertexShader_Cube::genSquareGrid(int size, GLfloat **vertices, GLuint **indices)
{
    int i, j;
